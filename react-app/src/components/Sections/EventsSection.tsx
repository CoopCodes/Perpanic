                ...
                <div className='h-fit w-full max-lg:mt-6'>
                    ...
                    {events.map((event, index) => (
                        ...
                        >
                            ...
                            >
                                <h3 className={`p1 text-xl lg:text-3xl text-nowrap transition-all sm:w-fit duration-200 text-ellipsis max-sm:overflow-hidden max-sm:min-w-[160px] ${eventIndex === index ? 'underline mb-1 text-xl lg:text-[28px] font-[600]' : ''}`}>{event.title}</h3>
                                <svg
