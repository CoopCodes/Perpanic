...
export function GallerySection({ events, scrollTop }: GallerySectionProps) {
    ...
    useEffect(() => {
        ...
        const eventPartition = scrollableDistance / events.length;
        ...
        if (
            ...
            const currentEventImages = events[eventIndex].images;
    ...
    }, [scrollTop, events, eventIndex, imageIndex])

    return (
        <div className="h-[200vh] lg:h-[100vh] max-lg:py-[50vh] container relative bg-textured-black" ref={containerRef}>
